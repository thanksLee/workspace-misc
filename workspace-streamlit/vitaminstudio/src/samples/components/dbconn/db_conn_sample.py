...
class DBConnSample:
    def __init__(self):
        ...
        self.__db_conn_str = f'{self._server_config.db_user}:{self._server_config.db_pwd}@{self._server_config.db_host}:{self._server_config.db_port}/{self._server_config.db}'
